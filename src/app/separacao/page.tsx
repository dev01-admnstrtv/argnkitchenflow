      ...
      {estatisticas && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">{estatisticas.solicitacoes.pendentes}</div>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-600">Em Separação</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{estatisticas.solicitacoes.separando}</div>
              <div className="text-sm text-gray-500">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">{estatisticas.itens.aguardando}</div>
              <div className="text-sm text-gray-500">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{estatisticas.tempoMedioMinutos}min</div>
              <div className="text-sm text-gray-500">
