...
import { Plus, Search, Trash2, ArrowLeft, Package, FileText, Sparkles, Star } from 'lucide-react'
          ...
          <Card className="bg-white border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <CardContent className="pt-6">
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Pesquisar por praça, observações ou status..."
                  value={filtro}
          ...
          <Card className="bg-white border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <CardHeader className="pb-4 bg-gradient-to-r from-slate-50 to-gray-50 border-b border-gray-200">
              <CardTitle className="flex items-center gap-3 text-xl text-gray-800">
                <div className="p-2 rounded-xl bg-gradient-to-br from-green-600 to-teal-600 shadow-lg">
